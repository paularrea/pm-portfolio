...
const en = {
  ...
  hero_intro: 'Product Manager · 5+ years in digital product · ex-frontend developer. <strong>I prototype to think</strong> — clear decisions, fewer surprises, faster shipping.',
  ...
  str3_title: 'Shipped ownership', str3_p: 'Two products end-to-end, strategy to production, no co-PM above or beside me. Scope, roadmap and trade-offs across four quarters — owned solo, reporting to the CEO.',
  ...
  card1_num: 'CASE 01 · PLATFORM MIGRATION', card1_title: 'Replatforming an eCommerce for ~300 schools', card1_desc: 'Moving a six-year-old Ember.js storefront to a modern, embeddable React widget — a faster, cleaner booking UX built to close more bookings, shipped while schools kept selling through it.',
  ...
  p2_title: 'Technical decisions in plain language', p2_body: "Two years as a frontend developer means I don't need constraints translated. My job is the reverse: turning architecture decisions into one sentence a non-engineer can act on — and knowing exactly where my technical opinion ends.", p2_proof: '→ Case 01: Shadow DOM consent isolation and the channel-parity principle',
  p3_title: 'Audit-driven delivery', p3_body: "Every release ships with a paired audit of what's missing versus the working legacy — severity-rated, owner-tagged. Open questions live in the PRD with names attached. The limitations doc publishes before launch.", p3_proof: '→ Case 01: 5 audits, 250+ test cases, a P0/P1/P2 limitations doc before launch',
...
const es = {
  ...
  hero_intro: 'Product Manager · 5+ años en producto digital · ex-developer frontend. <strong>Prototipo para pensar</strong> — decisiones claras, menos sorpresas, shipping más rápido.',
  ...
  str3_title: 'Ownership real', str3_p: 'Dos productos end-to-end, estrategia a producción, sin co-PM por encima ni al lado. Scope, roadmap y trade-offs durante cuatro trimestres — asumidos en solitario, reportando al CEO.',
  ...
  card1_num: 'CASO 01 · MIGRACIÓN DE PLATAFORMA', card1_title: 'Replataformizar un eCommerce para ~300 escuelas', card1_desc: 'Migrar un storefront de seis años en Ember.js a un widget embebible y moderno en React — una UX de reserva más rápida y cuidada para cerrar más reservas, shipeada mientras las escuelas seguían vendiendo.',
  ...
  p2_title: 'Decisiones técnicas en lenguaje accionable', p2_body: 'Dos años como developer frontend significa que no necesito que me traduzcan los constraints. Mi trabajo es la traducción inversa: convertir decisiones de arquitectura en una frase que cualquier persona del equipo pueda ejecutar.', p2_proof: '→ Caso 01: aislamiento de consentimiento con Shadow DOM y el principio de channel parity',
  p3_title: 'Delivery basado en auditorías', p3_body: 'Cada release incluye una auditoría de lo que falta respecto al legacy, con severidad y propietario asignado. Las preguntas abiertas viven en el PRD con nombres. El doc de limitaciones se publica antes del lanzamiento.', p3_proof: '→ Caso 01: 5 auditorías, 250+ casos de test, doc P0/P1/P2 antes del lanzamiento',
